...
/**
 * 行为日志管理端控制层。
 * 面向市级、区级管理员，提供行为日志列表查询。
 */
@RestController
@RequestMapping("/admin/behavior-log")
public class RecruitSiteBehaviorLogAdminController {

    private final RecruitSiteBehaviorLogBPO behaviorLogBPO;

    public RecruitSiteBehaviorLogAdminController(RecruitSiteBehaviorLogBPO behaviorLogBPO) {
